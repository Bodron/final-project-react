...
function SignIn() {
  return (
    <div> 
      ...
      <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label className='text-white bold'>Second name</Form.Label>
        <Form.Control type="password" placeholder="SecondName" />
      </Form.Group>
      ...
      <Form.Group className="mb-4" controlId="formBasicPassword">
        <Form.Label className='text-white bold'>Re-TypePassword</Form.Label>
        <Form.Control type="password" placeholder="Password" />
      </Form.Group>
